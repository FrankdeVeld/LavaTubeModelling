%% Goal of this function: transfrom an .stl 3D file into a structure usable for later analysis
% Author: The MathWorks, Inc.
% Date: 2011
% Output:  one structure with faces and vertices
% Source: https://nl.mathworks.com/matlabcentral/fileexchange/22409-stl-file-reader

% Function to read 3D stl files.

% This function is called automatically when running the
% 'Voxel_main.m' script
