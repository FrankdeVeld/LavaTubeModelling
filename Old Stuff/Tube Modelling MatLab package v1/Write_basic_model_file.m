...
function Write_basic_model_file(Rock_density, Model_name, Model_limit_vector, Cavity_limit_vector, Num_intermediate_sections) 
    ...
    Section_text = sprintf(Section_text,Model_limit_vector(1),Model_limit_vector(3),Model_limit_vector(2),Model_limit_vector(3));
    ...
    Temp_text = sprintf(Temp_text,Model_limit_vector(2)-Model_limit_vector(1),Model_limit_vector(5),0,Model_limit_vector(5),0,Model_limit_vector(6),Model_limit_vector(2)-Model_limit_vector(1),Model_limit_vector(6));
    ...
    Section_text = ['<geometry>' ...
      '<cross_section name="0" '...
      'x_start="%4.2f" y_start="%4.2f" x_end="%4.2f" y_end="%4.2f"></cross_section> \n'];
    Section_text = sprintf(Section_text,Model_limit_vector(1),Cavity_limit_vector(3),Model_limit_vector(2),Cavity_limit_vector(3));
    ...
    for a=1:Num_intermediate_sections
        Section_text = ['<geometry>' ...
          ...
          'x_start="%4.2f" y_start="%4.2f" x_end="%4.2f" y_end="%4.2f"></cross_section> \n'];
        Section_text = sprintf(Section_text,a,Model_limit_vector(1),a*(Cavity_limit_vector(4)-Cavity_limit_vector(3))/(Num_intermediate_sections + 1)+ Cavity_limit_vector(3),Model_limit_vector(2),a*(Cavity_limit_vector(4)-Cavity_limit_vector(3))/(Num_intermediate_sections + 1)+ Cavity_limit_vector(3));

        Temp_text = ['<vertex id="%d" x="%4.2f" z="%4.2f"></vertex> \n' ...
        '<vertex id="%d" x="%4.2f" z="%4.2f"></vertex> \n' ....
        '<vertex id="%d" x="%4.2f" z="%4.2f"></vertex> \n'...
        '<vertex id="%d" x="%4.2f" z="%4.2f"></vertex> \n'];
        Temp_text = sprintf(Temp_text,index + 1, Model_limit_vector(2)-Model_limit_vector(1),Model_limit_vector(5),index + 2,0,Model_limit_vector(5),index + 3,0,Model_limit_vector(6),index + 4,Model_limit_vector(2)-Model_limit_vector(1),Model_limit_vector(6));
        Section_text = [Section_text,Temp_text];
    ...
    Section_text = ['<geometry>' ...
      '<cross_section name="%d" '...
      'x_start="%4.2f" y_start="%4.2f" x_end="%4.2f" y_end="%4.2f"></cross_section> \n'];
    Section_text = sprintf(Section_text,a+1,Model_limit_vector(1),Model_limit_vector(4),Model_limit_vector(2),Model_limit_vector(4));
