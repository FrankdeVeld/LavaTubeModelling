With_cavity_results_f10 = xml2struct('C:\Users\frank\Dropbox\Studie\Stage\Documenten Lava Tubes\IGMAS\Tube Modelling MatLab package\Sizing Tests and Results\f10_With_Cavity.stations');

With_cavity_results_array_f10 = [];
for a=1:length(With_cavity_results_f10.geodata.vertex(1,:))

    Temp_x = With_cavity_results_f10.geodata.vertex{1,a}.Attributes.x;
    Temp_y = With_cavity_results_f10.geodata.vertex{1,a}.Attributes.y;

    Temp_result = With_cavity_results_f10.geodata.vertex{1,a}.property.Attributes.value;

    With_cavity_results_array_f10(a,1) = str2num(Temp_x);
    With_cavity_results_array_f10(a,2) = str2num(Temp_y);
    With_cavity_results_array_f10(a,3) = str2num(Temp_result);
end
clear a

No_cavity_results_f10 = xml2struct('C:\Users\frank\Dropbox\Studie\Stage\Documenten Lava Tubes\IGMAS\Tube Modelling MatLab package\Sizing Tests and Results\f10_No_Cavity.stations');

No_cavity_results_array_f10 = [];
for a=1:length(No_cavity_results_f10.geodata.vertex(1,:))

    Temp_x = No_cavity_results_f10.geodata.vertex{1,a}.Attributes.x;
    Temp_y = No_cavity_results_f10.geodata.vertex{1,a}.Attributes.y;

    Temp_result = No_cavity_results_f10.geodata.vertex{1,a}.property.Attributes.value;

    No_cavity_results_array_f10(a,1) = str2num(Temp_x);
    No_cavity_results_array_f10(a,2) = str2num(Temp_y);
    No_cavity_results_array_f10(a,3) = str2num(Temp_result);
end
clear a

tri = delaunay(With_cavity_results_array_f10(:,1), With_cavity_results_array_f10(:,2));
figure()
axis tight
trisurf(tri, With_cavity_results_array_f10(:,1),With_cavity_results_array_f10(:,2),No_cavity_results_array_f10(:,3)-With_cavity_results_array_f10(:,3))
...
ContourPlot(2,With_cavity_results_array_f10(:,1),With_cavity_results_array_f10(:,2),No_cavity_results_array_f10(:,3)-With_cavity_results_array_f10(:,3),labels)
