...
Sorted_plot_array(8:15,:) = [Plot_array(14,:);Plot_array(21,:);Plot_array(28,:);Plot_array(35,:);Plot_array(42,:);Plot_array(49,:);Plot_array(48,:);Plot_array(47,:)];
Sorted_plot_array(16:23,:) = [Plot_array(46,:);Plot_array(45,:);Plot_array(44,:);Plot_array(43,:);Plot_array(36,:);Plot_array(29,:);Plot_array(22,:);Plot_array(15,:)];
Sorted_plot_array(24:29,:) = Plot_array(8:13,:);
Sorted_plot_array(30:37,:) = [Plot_array(20,:);Plot_array(27,:);Plot_array(34,:);Plot_array(41,:);Plot_array(40,:);Plot_array(39,:);Plot_array(38,:);Plot_array(37,:)];
Sorted_plot_array(38:45,:) = [Plot_array(30,:);Plot_array(23,:);Plot_array(16,:);Plot_array(17,:);Plot_array(18,:);Plot_array(19,:);Plot_array(26,:);Plot_array(33,:)];
Sorted_plot_array(46:49,:) = [Plot_array(32,:);Plot_array(31,:);Plot_array(24,:);Plot_array(25,:)];

%%
MovieMatrix = struct('cdata',[],'colormap',[]);
Z_grid = NaN*ones(length(X(:,1)),length(X(1,:)));

v = VideoWriter('Grid50PointsWithCavity.avi');
open(v);
...
%         contour(X,Y,Z_spiral_int-base)
        ...
        str = sprintf('Contour map after %d gravity measurements, grid',d);
